 ...
 */
final class Version20200604154037 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE seance CHANGE module_id module_id INT DEFAULT NULL, CHANGE categorie_id categorie_id INT DEFAULT NULL, CHANGE formation_id formation_id INT NOT NULL, CHANGE title title VARCHAR(190) DEFAULT NULL, CHANGE number number VARCHAR(10) DEFAULT NULL, CHANGE modified modified DATETIME DEFAULT NULL, CHANGE support_link support_link VARCHAR(255) DEFAULT NULL');
