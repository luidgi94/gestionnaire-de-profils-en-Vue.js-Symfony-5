 ...
 */
final class Version20200607221037 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE message CHANGE object object VARCHAR(180) DEFAULT NULL, CHANGE modified modified DATETIME DEFAULT NULL, CHANGE user_mail_received_id usermailreceived_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE message CHANGE object object VARCHAR(180) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE modified modified DATETIME DEFAULT \'NULL\', CHANGE usermailreceived_id user_mail_received_id INT NOT NULL');
