<template>
  <div :class="{'fvl-has-error' : $parent.hasErrors(name)}" class="fvl-input-wrapper-teacherdate">
    <label v-if="label" :class="labelClass" :for="name" class="fvl-input-label-teacherdate" v-html="label" />
    <div class="fvl-input-group fvl-date-picker">
      ...
      <flat-pickr
        ...
        :class="['fvl-input-teacherdate', fieldClass]"
...
<script>
  import ValidationErrors from '../../../../node_modules/formvuelar/src/components/FvlErrors.vue'
